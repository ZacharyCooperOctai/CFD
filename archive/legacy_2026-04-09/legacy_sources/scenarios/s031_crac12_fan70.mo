// Auto-generated scenario: s031_crac12_fan70
// CRACs 1&2 @ 70%, rest @ 100%
model Scenario_s031_crac12_fan70
  ...
  Modelica.Blocks.Sources.CombiTimeTable fanTable(
    table = [0, 0.7000, 0.7000, 1.0000, 1.0000, 1.0000, 1.0000;
             900, 0.7000, 0.7000, 1.0000, 1.0000, 1.0000, 1.0000],
    columns = 2:7,
...
end Scenario_s031_crac12_fan70;
