...
equation index: 658
type: SIMPLE_ASSIGN
dc.weaDat.tWetBul_TDryBulXi.XiSat = 0.621964713077499 / (-0.378035286922501 + 0.0016349032219037793 * dc.weaDat.pAtmSel.p * exp(4102.99 / (dc.weaDat.weaBus.TWetBul - 35.719) - 17.2799))
*/
void s000_baseline_eqFunction_658(DATA *data, threadData_t *threadData)
{
  const int equationIndexes[2] = {1,658};
  (data->localData[0]->realVars[data->simulationInfo->realVarsIndex[417]] /* dc.weaDat.tWetBul_TDryBulXi.XiSat variable */) = DIVISION_SIM(0.621964713077499,-0.378035286922501 + (0.0016349032219037793) * (((data->simulationInfo->realParameter[data->simulationInfo->realParamsIndex[1523]] /* dc.weaDat.pAtmSel.p PARAM */)) * (exp(DIVISION_SIM(4102.99,(data->localData[0]->realVars[data->simulationInfo->realVarsIndex[428]] /* dc.weaDat.weaBus.TWetBul variable */) - 35.719,"dc.weaDat.weaBus.TWetBul - 35.719",equationIndexes) - 17.2799))),"-0.378035286922501 + 0.0016349032219037793 * dc.weaDat.pAtmSel.p * exp(4102.99 / (dc.weaDat.weaBus.TWetBul - 35.719) - 17.2799)",equationIndexes);
...
equation index: 2200
type: SIMPLE_ASSIGN
$cse16 = exp(4102.99 / (dc.weaDat.weaBus.TWetBul - 35.719) - 17.2799)
*/
void s000_baseline_eqFunction_2200(DATA *data, threadData_t *threadData)
{
  const int equationIndexes[2] = {1,2200};
  (data->localData[0]->realVars[data->simulationInfo->realVarsIndex[98]] /* $cse16 variable */) = exp(DIVISION_SIM(4102.99,(data->localData[0]->realVars[data->simulationInfo->realVarsIndex[428]] /* dc.weaDat.weaBus.TWetBul variable */) - 35.719,"dc.weaDat.weaBus.TWetBul - 35.719",equationIndexes) - 17.2799);
