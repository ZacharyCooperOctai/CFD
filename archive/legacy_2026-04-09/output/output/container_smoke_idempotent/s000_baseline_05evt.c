...
const char *s000_baseline_zeroCrossingDescription(int i, int **out_EquationIndexes)
{
  ...
  static const int occurEqs0[] = {1,1828};
  static const int occurEqs1[] = {1,2099};
  static const int occurEqs2[] = {1,2138};
  static const int occurEqs3[] = {1,2158};
  static const int occurEqs4[] = {1,2078};
  static const int occurEqs5[] = {1,2054};
  static const int occurEqs6[] = {1,2143};
  static const int occurEqs7[] = {1,2084};
  static const int occurEqs8[] = {1,2153};
  static const int occurEqs9[] = {1,2066};
  static const int occurEqs10[] = {1,2148};
  static const int occurEqs11[] = {1,2164};
  static const int occurEqs12[] = {1,2060};
  static const int occurEqs13[] = {1,2072};
  static const int occurEqs14[] = {1,2103};
  static const int occurEqs15[] = {1,2106};
...
int s000_baseline_function_ZeroCrossings(DATA *data, threadData_t *threadData, double *gout)
{
  ...
  tmp1 = 1.0;
  tmp2 = 1.0;
  tmp0 = GreaterEqZC(data->localData[0]->timeValue, (data->simulationInfo->realVarsPre[574] /* fanTable.nextTimeEvent DISCRETE */), tmp1, tmp2, data->simulationInfo->storedRelations[0]);
  ...
  tmp7 = 1.0;
  tmp8 = 0.0;
  tmp6 = GreaterZC((data->localData[0]->realVars[data->simulationInfo->realVarsIndex[174]] /* dc.roo.air.cfd.u[15] variable */), 0.0, tmp7, tmp8, data->simulationInfo->storedRelations[2]);
  ...
  tmp10 = 1.0;
  tmp11 = 0.0;
  tmp9 = GreaterZC((data->localData[0]->realVars[data->simulationInfo->realVarsIndex[170]] /* dc.roo.air.cfd.u[11] variable */), 0.0, tmp10, tmp11, data->simulationInfo->storedRelations[3]);
  gout[start_index] = (tmp9) ? 1 : -1;
  current_index++;

  start_index = current_index;
  tmp15 = Greater((data->simulationInfo->realParameter[data->simulationInfo->realParamsIndex[100]] /* dc.retRes[5].m_flow_nominal_pos PARAM */),1e-15);
  tmp13 = fabs((tmp15?(data->simulationInfo->realParameter[data->simulationInfo->realParamsIndex[100]] /* dc.retRes[5].m_flow_nominal_pos PARAM */):1.0));
  tmp14 = 0.0;
  tmp12 = GreaterZC((-(data->localData[0]->realVars[data->simulationInfo->realVarsIndex[179]] /* dc.roo.air.cfd.u[20] variable */)), 0.0, tmp13, tmp14, data->simulationInfo->storedRelations[4]);
  gout[start_index] = (tmp12) ? 1 : -1;
  current_index++;

  start_index = current_index;
  tmp19 = Greater((data->simulationInfo->realParameter[data->simulationInfo->realParamsIndex[96]] /* dc.retRes[1].m_flow_nominal_pos PARAM */),1e-15);
  tmp17 = fabs((tmp19?(data->simulationInfo->realParameter[data->simulationInfo->realParamsIndex[96]] /* dc.retRes[1].m_flow_nominal_pos PARAM */):1.0));
  tmp18 = 0.0;
  tmp16 = GreaterZC((-(data->localData[0]->realVars[data->simulationInfo->realVarsIndex[175]] /* dc.roo.air.cfd.u[16] variable */)), 0.0, tmp17, tmp18, data->simulationInfo->storedRelations[5]);
  gout[start_index] = (tmp16) ? 1 : -1;
  current_index++;

  start_index = current_index;
  tmp21 = 1.0;
  tmp22 = 0.0;
  tmp20 = GreaterZC((data->localData[0]->realVars[data->simulationInfo->realVarsIndex[173]] /* dc.roo.air.cfd.u[14] variable */), 0.0, tmp21, tmp22, data->simulationInfo->storedRelations[6]);
  gout[start_index] = (tmp20) ? 1 : -1;
  current_index++;

  start_index = current_index;
  tmp26 = Greater((data->simulationInfo->realParameter[data->simulationInfo->realParamsIndex[101]] /* dc.retRes[6].m_flow_nominal_pos PARAM */),1e-15);
  tmp24 = fabs((tmp26?(data->simulationInfo->realParameter[data->simulationInfo->realParamsIndex[101]] /* dc.retRes[6].m_flow_nominal_pos PARAM */):1.0));
  tmp25 = 0.0;
  tmp23 = GreaterZC((-(data->localData[0]->realVars[data->simulationInfo->realVarsIndex[180]] /* dc.roo.air.cfd.u[21] variable */)), 0.0, tmp24, tmp25, data->simulationInfo->storedRelations[7]);
  ...
  tmp28 = 1.0;
  tmp29 = 0.0;
  tmp27 = GreaterZC((data->localData[0]->realVars[data->simulationInfo->realVarsIndex[171]] /* dc.roo.air.cfd.u[12] variable */), 0.0, tmp28, tmp29, data->simulationInfo->storedRelations[8]);
  gout[start_index] = (tmp27) ? 1 : -1;
  current_index++;

  start_index = current_index;
  tmp33 = Greater((data->simulationInfo->realParameter[data->simulationInfo->realParamsIndex[98]] /* dc.retRes[3].m_flow_nominal_pos PARAM */),1e-15);
  tmp31 = fabs((tmp33?(data->simulationInfo->realParameter[data->simulationInfo->realParamsIndex[98]] /* dc.retRes[3].m_flow_nominal_pos PARAM */):1.0));
  tmp32 = 0.0;
  tmp30 = GreaterZC((-(data->localData[0]->realVars[data->simulationInfo->realVarsIndex[177]] /* dc.roo.air.cfd.u[18] variable */)), 0.0, tmp31, tmp32, data->simulationInfo->storedRelations[9]);
  ...
  tmp35 = 1.0;
  tmp36 = 0.0;
  tmp34 = GreaterZC((data->localData[0]->realVars[data->simulationInfo->realVarsIndex[172]] /* dc.roo.air.cfd.u[13] variable */), 0.0, tmp35, tmp36, data->simulationInfo->storedRelations[10]);
  ...
  tmp38 = 1.0;
  tmp39 = 0.0;
  tmp37 = GreaterZC((data->localData[0]->realVars[data->simulationInfo->realVarsIndex[169]] /* dc.roo.air.cfd.u[10] variable */), 0.0, tmp38, tmp39, data->simulationInfo->storedRelations[11]);
  gout[start_index] = (tmp37) ? 1 : -1;
  current_index++;

  start_index = current_index;
  tmp43 = Greater((data->simulationInfo->realParameter[data->simulationInfo->realParamsIndex[97]] /* dc.retRes[2].m_flow_nominal_pos PARAM */),1e-15);
  tmp41 = fabs((tmp43?(data->simulationInfo->realParameter[data->simulationInfo->realParamsIndex[97]] /* dc.retRes[2].m_flow_nominal_pos PARAM */):1.0));
  tmp42 = 0.0;
  tmp40 = GreaterZC((-(data->localData[0]->realVars[data->simulationInfo->realVarsIndex[176]] /* dc.roo.air.cfd.u[17] variable */)), 0.0, tmp41, tmp42, data->simulationInfo->storedRelations[12]);
  gout[start_index] = (tmp40) ? 1 : -1;
  current_index++;

  start_index = current_index;
  tmp47 = Greater((data->simulationInfo->realParameter[data->simulationInfo->realParamsIndex[99]] /* dc.retRes[4].m_flow_nominal_pos PARAM */),1e-15);
  ...
  tmp49 = 1.0;
  tmp50 = 1.0;
  tmp48 = GreaterZC((data->localData[0]->realVars[data->simulationInfo->realVarsIndex[376]] /* dc.weaDat.add30Min.y variable */), (data->simulationInfo->realVarsPre[573] /* dc.weaDat.conTimMin.tNext DISCRETE */), tmp49, tmp50, data->simulationInfo->storedRelations[14]);
  gout[start_index] = (((data->simulationInfo->booleanParameter[data->simulationInfo->booleanParamsIndex[344]] /* dc.weaDat.conTimMin.canRepeatWeatherFile PARAM */) && tmp48)) ? 1 : -1;
  current_index++;

  start_index = current_index;
  tmp52 = 1.0;
  tmp53 = 1.0;
  tmp51 = GreaterZC((data->localData[0]->realVars[data->simulationInfo->realVarsIndex[430]] /* dc.weaDat.weaBus.cloTim variable */), (data->simulationInfo->realVarsPre[572] /* dc.weaDat.conTim.tNext DISCRETE */), tmp52, tmp53, data->simulationInfo->storedRelations[15]);
  gout[start_index] = (((data->simulationInfo->booleanParameter[data->simulationInfo->booleanParamsIndex[343]] /* dc.weaDat.conTim.canRepeatWeatherFile PARAM */) && tmp51)) ? 1 : -1;
  current_index++;
...
int s000_baseline_function_updateRelations(DATA *data, threadData_t *threadData, int evalforZeroCross)
{
  ...
  if(evalforZeroCross) {
    ...
    tmp55 = 1.0;
    tmp56 = 1.0;
    tmp54 = GreaterEqZC(data->localData[0]->timeValue, (data->simulationInfo->realVarsPre[574] /* fanTable.nextTimeEvent DISCRETE */), tmp55, tmp56, data->simulationInfo->storedRelations[0]);
    ...
    tmp61 = 1.0;
    tmp62 = 0.0;
    tmp60 = GreaterZC((data->localData[0]->realVars[data->simulationInfo->realVarsIndex[174]] /* dc.roo.air.cfd.u[15] variable */), 0.0, tmp61, tmp62, data->simulationInfo->storedRelations[2]);
    ...
    tmp64 = 1.0;
    tmp65 = 0.0;
    tmp63 = GreaterZC((data->localData[0]->realVars[data->simulationInfo->realVarsIndex[170]] /* dc.roo.air.cfd.u[11] variable */), 0.0, tmp64, tmp65, data->simulationInfo->storedRelations[3]);
    data->simulationInfo->relations[start_index] = tmp63;
    current_index++;

    start_index = current_index;
    tmp69 = Greater((data->simulationInfo->realParameter[data->simulationInfo->realParamsIndex[100]] /* dc.retRes[5].m_flow_nominal_pos PARAM */),1e-15);
    tmp67 = fabs((tmp69?(data->simulationInfo->realParameter[data->simulationInfo->realParamsIndex[100]] /* dc.retRes[5].m_flow_nominal_pos PARAM */):1.0));
    tmp68 = 0.0;
    tmp66 = GreaterZC((-(data->localData[0]->realVars[data->simulationInfo->realVarsIndex[179]] /* dc.roo.air.cfd.u[20] variable */)), 0.0, tmp67, tmp68, data->simulationInfo->storedRelations[4]);
    data->simulationInfo->relations[start_index] = tmp66;
    current_index++;

    start_index = current_index;
    tmp73 = Greater((data->simulationInfo->realParameter[data->simulationInfo->realParamsIndex[96]] /* dc.retRes[1].m_flow_nominal_pos PARAM */),1e-15);
    tmp71 = fabs((tmp73?(data->simulationInfo->realParameter[data->simulationInfo->realParamsIndex[96]] /* dc.retRes[1].m_flow_nominal_pos PARAM */):1.0));
    tmp72 = 0.0;
    tmp70 = GreaterZC((-(data->localData[0]->realVars[data->simulationInfo->realVarsIndex[175]] /* dc.roo.air.cfd.u[16] variable */)), 0.0, tmp71, tmp72, data->simulationInfo->storedRelations[5]);
    ...
    tmp75 = 1.0;
    tmp76 = 0.0;
    tmp74 = GreaterZC((data->localData[0]->realVars[data->simulationInfo->realVarsIndex[173]] /* dc.roo.air.cfd.u[14] variable */), 0.0, tmp75, tmp76, data->simulationInfo->storedRelations[6]);
    data->simulationInfo->relations[start_index] = tmp74;
    current_index++;

    start_index = current_index;
    tmp80 = Greater((data->simulationInfo->realParameter[data->simulationInfo->realParamsIndex[101]] /* dc.retRes[6].m_flow_nominal_pos PARAM */),1e-15);
    tmp78 = fabs((tmp80?(data->simulationInfo->realParameter[data->simulationInfo->realParamsIndex[101]] /* dc.retRes[6].m_flow_nominal_pos PARAM */):1.0));
    tmp79 = 0.0;
    tmp77 = GreaterZC((-(data->localData[0]->realVars[data->simulationInfo->realVarsIndex[180]] /* dc.roo.air.cfd.u[21] variable */)), 0.0, tmp78, tmp79, data->simulationInfo->storedRelations[7]);
    ...
    tmp82 = 1.0;
    tmp83 = 0.0;
    tmp81 = GreaterZC((data->localData[0]->realVars[data->simulationInfo->realVarsIndex[171]] /* dc.roo.air.cfd.u[12] variable */), 0.0, tmp82, tmp83, data->simulationInfo->storedRelations[8]);
    data->simulationInfo->relations[start_index] = tmp81;
    current_index++;

    start_index = current_index;
    tmp87 = Greater((data->simulationInfo->realParameter[data->simulationInfo->realParamsIndex[98]] /* dc.retRes[3].m_flow_nominal_pos PARAM */),1e-15);
    tmp85 = fabs((tmp87?(data->simulationInfo->realParameter[data->simulationInfo->realParamsIndex[98]] /* dc.retRes[3].m_flow_nominal_pos PARAM */):1.0));
    tmp86 = 0.0;
    tmp84 = GreaterZC((-(data->localData[0]->realVars[data->simulationInfo->realVarsIndex[177]] /* dc.roo.air.cfd.u[18] variable */)), 0.0, tmp85, tmp86, data->simulationInfo->storedRelations[9]);
    ...
    tmp89 = 1.0;
    tmp90 = 0.0;
    tmp88 = GreaterZC((data->localData[0]->realVars[data->simulationInfo->realVarsIndex[172]] /* dc.roo.air.cfd.u[13] variable */), 0.0, tmp89, tmp90, data->simulationInfo->storedRelations[10]);
    ...
    tmp92 = 1.0;
    tmp93 = 0.0;
    tmp91 = GreaterZC((data->localData[0]->realVars[data->simulationInfo->realVarsIndex[169]] /* dc.roo.air.cfd.u[10] variable */), 0.0, tmp92, tmp93, data->simulationInfo->storedRelations[11]);
    data->simulationInfo->relations[start_index] = tmp91;
    current_index++;

    start_index = current_index;
    tmp97 = Greater((data->simulationInfo->realParameter[data->simulationInfo->realParamsIndex[97]] /* dc.retRes[2].m_flow_nominal_pos PARAM */),1e-15);
    tmp95 = fabs((tmp97?(data->simulationInfo->realParameter[data->simulationInfo->realParamsIndex[97]] /* dc.retRes[2].m_flow_nominal_pos PARAM */):1.0));
    tmp96 = 0.0;
    tmp94 = GreaterZC((-(data->localData[0]->realVars[data->simulationInfo->realVarsIndex[176]] /* dc.roo.air.cfd.u[17] variable */)), 0.0, tmp95, tmp96, data->simulationInfo->storedRelations[12]);
    data->simulationInfo->relations[start_index] = tmp94;
    current_index++;

    start_index = current_index;
    tmp101 = Greater((data->simulationInfo->realParameter[data->simulationInfo->realParamsIndex[99]] /* dc.retRes[4].m_flow_nominal_pos PARAM */),1e-15);
    ...
    tmp103 = 1.0;
    tmp104 = 1.0;
    tmp102 = GreaterZC((data->localData[0]->realVars[data->simulationInfo->realVarsIndex[376]] /* dc.weaDat.add30Min.y variable */), (data->simulationInfo->realVarsPre[573] /* dc.weaDat.conTimMin.tNext DISCRETE */), tmp103, tmp104, data->simulationInfo->storedRelations[14]);
    ...
    tmp106 = 1.0;
    tmp107 = 1.0;
    tmp105 = GreaterZC((data->localData[0]->realVars[data->simulationInfo->realVarsIndex[430]] /* dc.weaDat.weaBus.cloTim variable */), (data->simulationInfo->realVarsPre[572] /* dc.weaDat.conTim.tNext DISCRETE */), tmp106, tmp107, data->simulationInfo->storedRelations[15]);
    data->simulationInfo->relations[start_index] = tmp105;
    current_index++;
  } else {
    start_index = current_index;
    data->simulationInfo->relations[start_index] = (data->localData[0]->timeValue >= (data->simulationInfo->realVarsPre[574] /* fanTable.nextTimeEvent DISCRETE */));
    current_index++;
    ...
    start_index = current_index;
    data->simulationInfo->relations[start_index] = ((data->localData[0]->realVars[data->simulationInfo->realVarsIndex[376]] /* dc.weaDat.add30Min.y variable */) > (data->simulationInfo->realVarsPre[573] /* dc.weaDat.conTimMin.tNext DISCRETE */));
    current_index++;

    start_index = current_index;
    data->simulationInfo->relations[start_index] = ((data->localData[0]->realVars[data->simulationInfo->realVarsIndex[430]] /* dc.weaDat.weaBus.cloTim variable */) > (data->simulationInfo->realVarsPre[572] /* dc.weaDat.conTim.tNext DISCRETE */));
    current_index++;
  }
