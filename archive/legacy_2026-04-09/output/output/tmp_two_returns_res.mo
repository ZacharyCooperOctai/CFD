...
model TmpTwoReturnsRes
  ...
  Buildings.Fluid.Sources.MassFlowSource_T sup1(redeclare package Medium=MediumA, nPorts=1, use_m_flow_in=true, use_T_in=true, m_flow=m_flow_rated, T=287.15);
  Buildings.Fluid.Sources.MassFlowSource_T sup2(redeclare package Medium=MediumA, nPorts=1, use_m_flow_in=true, use_T_in=true, m_flow=m_flow_rated, T=287.15);
  Buildings.Fluid.FixedResistances.PressureDrop retRes1(redeclare package Medium=MediumA, m_flow_nominal=m_flow_rated, dp_nominal=10, allowFlowReversal=false);
  Buildings.Fluid.FixedResistances.PressureDrop retRes2(redeclare package Medium=MediumA, m_flow_nominal=m_flow_rated, dp_nominal=10, allowFlowReversal=false);
...
equation
  ...
  connect(roo.ports[3], retRes1.port_a);
  connect(retRes1.port_b, ret.ports[1]);
  connect(roo.ports[4], retRes2.port_a);
  connect(retRes2.port_b, ret.ports[2]);
end TmpTwoReturnsRes;
