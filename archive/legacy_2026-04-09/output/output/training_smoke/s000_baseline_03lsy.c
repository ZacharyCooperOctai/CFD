...
equation index: 1977
type: SIMPLE_ASSIGN
dc.roo.irRadExc.G[6] = (-dc.roo.irRadExc.F[5,6]) * dc.roo.irRadExc.J[5] - dc.roo.irRadExc.F[6,6] * dc.roo.irRadExc.J[6] - dc.roo.irRadExc.F[4,6] * dc.roo.irRadExc.J[4] - dc.roo.irRadExc.F[3,6] * dc.roo.irRadExc.J[3] - dc.roo.irRadExc.F[2,6] * dc.roo.irRadExc.J[2] - dc.roo.irRadExc.F[1,6] * dc.roo.irRadExc.J[1]
*/
...
void residualFunc1995(RESIDUAL_USERDATA* userData, const double* xloc, double* res, const int* iflag)
{
  ...
  (data->localData[0]->realVars[data->simulationInfo->realVarsIndex[257]] /* dc.roo.irRadExc.J[5] variable */) = xloc[2];
  (data->localData[0]->realVars[data->simulationInfo->realVarsIndex[255]] /* dc.roo.irRadExc.J[3] variable */) = xloc[3];
  (data->localData[0]->realVars[data->simulationInfo->realVarsIndex[253]] /* dc.roo.irRadExc.J[1] variable */) = xloc[4];
  /* local constraints */
  s000_baseline_eqFunction_1971(data, threadData);
  /* local constraints */
...
OMC_DISABLE_OPT
void initializeStaticLSData1995(DATA* data, threadData_t* threadData, LINEAR_SYSTEM_DATA* linearSystemData, modelica_boolean initSparsePattern)
{
  const int indices[5] = {
...
dc.roo.irRadExc.G[4] = ((-dc.roo.irRadExc.T4Opa[4]) - dc.roo.irRadExc.J[4] * dc.roo.irRadExc.kOpaInv[4]) / (dc.roo.irRadExc.kOpaInv[4] * dc.roo.irRadExc.rhoOpa[4])
*/
void s000_baseline_eqFunction_1173(DATA *data, threadData_t *threadData)
{
...
*/
void s000_baseline_eqFunction_1174(DATA *data, threadData_t *threadData)
{
...
dc.roo.irRadExc.G[2] = (-dc.roo.irRadExc.F[5,2]) * dc.roo.irRadExc.J[5] - dc.roo.irRadExc.F[6,2] * dc.roo.irRadExc.J[6] - dc.roo.irRadExc.F[4,2] * dc.roo.irRadExc.J[4] - dc.roo.irRadExc.F[3,2] * dc.roo.irRadExc.J[3] - dc.roo.irRadExc.F[2,2] * dc.roo.irRadExc.J[2] - dc.roo.irRadExc.F[1,2] * dc.roo.irRadExc.J[1]
*/
void s000_baseline_eqFunction_1175(DATA *data, threadData_t *threadData)
{
...
*/
void s000_baseline_eqFunction_1176(DATA *data, threadData_t *threadData)
{
...
void residualFunc1194(RESIDUAL_USERDATA* userData, const double* xloc, double* res, const int* iflag)
{
  DATA *data = userData->data;
  threadData_t *threadData = userData->threadData;
  ...
  /* local constraints */
  s000_baseline_eqFunction_1173(data, threadData);
  /* local constraints */
  s000_baseline_eqFunction_1174(data, threadData);
  /* local constraints */
  s000_baseline_eqFunction_1175(data, threadData);
  /* local constraints */
  s000_baseline_eqFunction_1176(data, threadData);
...
OMC_DISABLE_OPT
void initializeStaticLSData1194(DATA* data, threadData_t* threadData, LINEAR_SYSTEM_DATA* linearSystemData, modelica_boolean initSparsePattern)
{
  const int indices[5] = {
    254 /* dc.roo.irRadExc.J[2] */,
    256 /* dc.roo.irRadExc.J[4] */,
...
void s000_baseline_initialLinearSystem(int nLinearSystems, LINEAR_SYSTEM_DATA* linearSystemData)
{
  ...
  linearSystemData[2].setA = NULL;  //setLinearMatrixA1995;
  linearSystemData[2].setb = NULL;  //setLinearVectorb1995;
  linearSystemData[2].initializeStaticLSData = initializeStaticLSData1995;
  
  assertStreamPrint(NULL, nLinearSystems > 1, "Internal Error: indexlinearSystem mismatch!");
  linearSystemData[1].equationIndex = 1194;
  linearSystemData[1].size = 5;
  linearSystemData[1].nnz = 0;
  linearSystemData[1].method = 1;   /* Symbolic Jacobian available */
  linearSystemData[1].residualFunc = residualFunc1194;
  ...
  linearSystemData[1].setA = NULL;  //setLinearMatrixA1194;
  linearSystemData[1].setb = NULL;  //setLinearVectorb1194;
  linearSystemData[1].initializeStaticLSData = initializeStaticLSData1194;
