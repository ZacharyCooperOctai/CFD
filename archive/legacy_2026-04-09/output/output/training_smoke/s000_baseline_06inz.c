...
*/
OMC_DISABLE_OPT
void s000_baseline_eqFunction_1194(DATA *data, threadData_t *threadData)
{
  ...
  infoStreamPrint(OMC_LOG_DT, 0, "Solving linear system 1194 (STRICT TEARING SET if tearing enabled) at time = %18.10e", data->localData[0]->timeValue);
  ...
  if (retValue > 0){
    ...
    throwStreamPrintWithEquationIndexes(threadData, omc_dummyFileInfo, indexes, "Solving linear system 1194 failed at time=%.15g.\nFor more information please use -lv LOG_LS.", data->localData[0]->timeValue);
  }
  /* write solution */
...
*/
void s000_baseline_eqFunction_1348(DATA *data, threadData_t *threadData)
{
...
*/
void s000_baseline_eqFunction_1351(DATA *data, threadData_t *threadData)
{
...
*/
void s000_baseline_eqFunction_1354(DATA *data, threadData_t *threadData)
{
...
*/
void s000_baseline_eqFunction_1357(DATA *data, threadData_t *threadData)
{
...
*/
void s000_baseline_eqFunction_1360(DATA *data, threadData_t *threadData)
{
...
*/
void s000_baseline_eqFunction_1363(DATA *data, threadData_t *threadData)
{
...
extern void s000_baseline_eqFunction_594(DATA *data, threadData_t *threadData);

extern void s000_baseline_eqFunction_595(DATA *data, threadData_t *threadData);

extern void s000_baseline_eqFunction_596(DATA *data, threadData_t *threadData);

extern void s000_baseline_eqFunction_597(DATA *data, threadData_t *threadData);
...
extern void s000_baseline_eqFunction_600(DATA *data, threadData_t *threadData);
...
extern void s000_baseline_eqFunction_610(DATA *data, threadData_t *threadData);

extern void s000_baseline_eqFunction_611(DATA *data, threadData_t *threadData);

extern void s000_baseline_eqFunction_2193(DATA *data, threadData_t *threadData);

extern void s000_baseline_eqFunction_613(DATA *data, threadData_t *threadData);
...
extern void s000_baseline_eqFunction_638(DATA *data, threadData_t *threadData);
...
extern void s000_baseline_eqFunction_643(DATA *data, threadData_t *threadData);
...
extern void s000_baseline_eqFunction_653(DATA *data, threadData_t *threadData);
...
extern void s000_baseline_eqFunction_659(DATA *data, threadData_t *threadData);

extern void s000_baseline_eqFunction_2241(DATA *data, threadData_t *threadData);

extern void s000_baseline_eqFunction_661(DATA *data, threadData_t *threadData);


void s000_baseline_eqFunction_1595(DATA*, threadData_t*);
void s000_baseline_eqFunction_1596(DATA*, threadData_t*);
void s000_baseline_eqFunction_1597(DATA*, threadData_t*);
/*
equation index: 1602
indexNonlinear: 7
type: NONLINEAR
...
eqns: {1595, 1596, 1597}
*/
void s000_baseline_eqFunction_1602(DATA *data, threadData_t *threadData)
{
  const int equationIndexes[2] = {1,1602};
  int retValue;
  infoStreamPrint(OMC_LOG_DT, 0, "Solving nonlinear system 1602 (STRICT TEARING SET if tearing enabled) at time = %18.10e", data->localData[0]->timeValue);
  /* get old value */
  ...
  /* check if solution process was successful */
  if (retValue > 0){
    const int indexes[2] = {1,1602};
    throwStreamPrintWithEquationIndexes(threadData, omc_dummyFileInfo, indexes, "Solving non-linear system 1602 failed at time=%.15g.\nFor more information please use -lv LOG_NLS.", data->localData[0]->timeValue);
  }
  /* write solution */
...
extern void s000_baseline_eqFunction_672(DATA *data, threadData_t *threadData);

extern void s000_baseline_eqFunction_673(DATA *data, threadData_t *threadData);

extern void s000_baseline_eqFunction_674(DATA *data, threadData_t *threadData);
...
*/
void s000_baseline_eqFunction_1609(DATA *data, threadData_t *threadData)
{
...
extern void s000_baseline_eqFunction_677(DATA *data, threadData_t *threadData);

extern void s000_baseline_eqFunction_2056(DATA *data, threadData_t *threadData);

extern void s000_baseline_eqFunction_679(DATA *data, threadData_t *threadData);

extern void s000_baseline_eqFunction_680(DATA *data, threadData_t *threadData);
...
extern void s000_baseline_eqFunction_693(DATA *data, threadData_t *threadData);
...
extern void s000_baseline_eqFunction_726(DATA *data, threadData_t *threadData);

extern void s000_baseline_eqFunction_727(DATA *data, threadData_t *threadData);
...
extern void s000_baseline_eqFunction_899(DATA *data, threadData_t *threadData);

extern void s000_baseline_eqFunction_900(DATA *data, threadData_t *threadData);

extern void s000_baseline_eqFunction_901(DATA *data, threadData_t *threadData);

extern void s000_baseline_eqFunction_902(DATA *data, threadData_t *threadData);

int s000_baseline_functionInitialEquations_lambda0(DATA *data, threadData_t *threadData)
{
  data->simulationInfo->discreteCall = 1;
  static void (*const eqFunctions[865])(DATA*, threadData_t*) = {
