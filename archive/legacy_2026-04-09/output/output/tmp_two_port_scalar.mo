...
model TmpTwoPortScalar
  ...
  Buildings.Fluid.Sources.Boundary_pT ret1(redeclare package Medium=MediumA, nPorts=1);
  Buildings.Fluid.Sources.Boundary_pT ret2(redeclare package Medium=MediumA, nPorts=1);
...
equation
  ...
  connect(roo.ports[3], ret1.ports[1]);
  connect(roo.ports[4], ret2.ports[1]);
end TmpTwoPortScalar;
