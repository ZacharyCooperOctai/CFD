#ifndef tmp_one_port__H
#define tmp_one_port__H
...
typedef struct {
  ...
  modelica_real _T;
  real_array _X;
} TmpOnePort_retSink_Medium_ThermodynamicState;
extern struct record_description TmpOnePort_retSink_Medium_ThermodynamicState__desc;

void TmpOnePort_retSink_Medium_ThermodynamicState_construct_p(threadData_t *threadData, void* v_ths );
#define TmpOnePort_retSink_Medium_ThermodynamicState_construct(td, ths ) TmpOnePort_retSink_Medium_ThermodynamicState_construct_p(td, &ths )
void TmpOnePort_retSink_Medium_ThermodynamicState_copy_p(void* v_src, void* v_dst);
#define TmpOnePort_retSink_Medium_ThermodynamicState_copy(src,dst) TmpOnePort_retSink_Medium_ThermodynamicState_copy_p(&src, &dst)
...
#define TmpOnePort_retSink_Medium_ThermodynamicState_wrap_vars(td, dst , in_p, in_T, in_X) TmpOnePort_retSink_Medium_ThermodynamicState_wrap_vars_p(td, &dst , in_p, in_T, in_X)
...
// void TmpOnePort_retSink_Medium_ThermodynamicState_copy_to_vars_p(void* v_src , modelica_real* in_p, modelica_real* in_T, real_array* in_X);
// #define TmpOnePort_retSink_Medium_ThermodynamicState_copy_to_vars(src,...) TmpOnePort_retSink_Medium_ThermodynamicState_copy_to_vars_p(&src, __VA_ARGS__)

typedef base_array_t TmpOnePort_retSink_Medium_ThermodynamicState_array;
#define alloc_TmpOnePort_retSink_Medium_ThermodynamicState_array(dst,ndims,...) generic_array_create(NULL, dst, TmpOnePort_retSink_Medium_ThermodynamicState_construct_p, ndims, sizeof(TmpOnePort_retSink_Medium_ThermodynamicState), __VA_ARGS__)
#define TmpOnePort_retSink_Medium_ThermodynamicState_array_copy_data(src,dst)   generic_array_copy_data(src, &dst, TmpOnePort_retSink_Medium_ThermodynamicState_copy_p, sizeof(TmpOnePort_retSink_Medium_ThermodynamicState))
#define TmpOnePort_retSink_Medium_ThermodynamicState_array_alloc_copy(src,dst)  generic_array_alloc_copy(src, &dst, TmpOnePort_retSink_Medium_ThermodynamicState_copy_p, sizeof(TmpOnePort_retSink_Medium_ThermodynamicState))
#define TmpOnePort_retSink_Medium_ThermodynamicState_array_get(src,ndims,...)   (*(TmpOnePort_retSink_Medium_ThermodynamicState*)(generic_array_get(&src, sizeof(TmpOnePort_retSink_Medium_ThermodynamicState), __VA_ARGS__)))
#define TmpOnePort_retSink_Medium_ThermodynamicState_set(dst,val,...)           generic_array_set(&dst, &val, TmpOnePort_retSink_Medium_ThermodynamicState_copy_p, sizeof(TmpOnePort_retSink_Medium_ThermodynamicState), __VA_ARGS__)

typedef TmpOnePort_retSink_Medium_ThermodynamicState TmpOnePort_roo_air_Medium_ThermodynamicState;
extern struct record_description TmpOnePort_roo_air_Medium_ThermodynamicState__desc;

void TmpOnePort_roo_air_Medium_ThermodynamicState_construct_p(threadData_t *threadData, void* v_ths );
#define TmpOnePort_roo_air_Medium_ThermodynamicState_construct(td, ths ) TmpOnePort_roo_air_Medium_ThermodynamicState_construct_p(td, &ths )
void TmpOnePort_roo_air_Medium_ThermodynamicState_copy_p(void* v_src, void* v_dst);
#define TmpOnePort_roo_air_Medium_ThermodynamicState_copy(src,dst) TmpOnePort_roo_air_Medium_ThermodynamicState_copy_p(&src, &dst)
...
#define TmpOnePort_roo_air_Medium_ThermodynamicState_wrap_vars(td, dst , in_p, in_T, in_X) TmpOnePort_roo_air_Medium_ThermodynamicState_wrap_vars_p(td, &dst , in_p, in_T, in_X)

// This function is not needed anymore. If you want to know how a record
// is 'assigned to' in simulation context see assignRhsExpToRecordCrefSimContext and
// splitRecordAssignmentToMemberAssignments (simCode). Basically the record is
// split up assignments generated for each member individually.
// void TmpOnePort_roo_air_Medium_ThermodynamicState_copy_to_vars_p(void* v_src , modelica_real* in_p, modelica_real* in_T, real_array* in_X);
// #define TmpOnePort_roo_air_Medium_ThermodynamicState_copy_to_vars(src,...) TmpOnePort_roo_air_Medium_ThermodynamicState_copy_to_vars_p(&src, __VA_ARGS__)

typedef base_array_t TmpOnePort_roo_air_Medium_ThermodynamicState_array;
#define alloc_TmpOnePort_roo_air_Medium_ThermodynamicState_array(dst,ndims,...) generic_array_create(NULL, dst, TmpOnePort_roo_air_Medium_ThermodynamicState_construct_p, ndims, sizeof(TmpOnePort_roo_air_Medium_ThermodynamicState), __VA_ARGS__)
#define TmpOnePort_roo_air_Medium_ThermodynamicState_array_copy_data(src,dst)   generic_array_copy_data(src, &dst, TmpOnePort_roo_air_Medium_ThermodynamicState_copy_p, sizeof(TmpOnePort_roo_air_Medium_ThermodynamicState))
#define TmpOnePort_roo_air_Medium_ThermodynamicState_array_alloc_copy(src,dst)  generic_array_alloc_copy(src, &dst, TmpOnePort_roo_air_Medium_ThermodynamicState_copy_p, sizeof(TmpOnePort_roo_air_Medium_ThermodynamicState))
#define TmpOnePort_roo_air_Medium_ThermodynamicState_array_get(src,ndims,...)   (*(TmpOnePort_roo_air_Medium_ThermodynamicState*)(generic_array_get(&src, sizeof(TmpOnePort_roo_air_Medium_ThermodynamicState), __VA_ARGS__)))
#define TmpOnePort_roo_air_Medium_ThermodynamicState_set(dst,val,...)           generic_array_set(&dst, &val, TmpOnePort_roo_air_Medium_ThermodynamicState_copy_p, sizeof(TmpOnePort_roo_air_Medium_ThermodynamicState), __VA_ARGS__)

typedef TmpOnePort_retSink_Medium_ThermodynamicState TmpOnePort_roo_air_fluInt_Medium_ThermodynamicState;
extern struct record_description TmpOnePort_roo_air_fluInt_Medium_ThermodynamicState__desc;

void TmpOnePort_roo_air_fluInt_Medium_ThermodynamicState_construct_p(threadData_t *threadData, void* v_ths );
#define TmpOnePort_roo_air_fluInt_Medium_ThermodynamicState_construct(td, ths ) TmpOnePort_roo_air_fluInt_Medium_ThermodynamicState_construct_p(td, &ths )
void TmpOnePort_roo_air_fluInt_Medium_ThermodynamicState_copy_p(void* v_src, void* v_dst);
#define TmpOnePort_roo_air_fluInt_Medium_ThermodynamicState_copy(src,dst) TmpOnePort_roo_air_fluInt_Medium_ThermodynamicState_copy_p(&src, &dst)
...
#define TmpOnePort_roo_air_fluInt_Medium_ThermodynamicState_wrap_vars(td, dst , in_p, in_T, in_X) TmpOnePort_roo_air_fluInt_Medium_ThermodynamicState_wrap_vars_p(td, &dst , in_p, in_T, in_X)

// This function is not needed anymore. If you want to know how a record
// is 'assigned to' in simulation context see assignRhsExpToRecordCrefSimContext and
// splitRecordAssignmentToMemberAssignments (simCode). Basically the record is
// split up assignments generated for each member individually.
// void TmpOnePort_roo_air_fluInt_Medium_ThermodynamicState_copy_to_vars_p(void* v_src , modelica_real* in_p, modelica_real* in_T, real_array* in_X);
// #define TmpOnePort_roo_air_fluInt_Medium_ThermodynamicState_copy_to_vars(src,...) TmpOnePort_roo_air_fluInt_Medium_ThermodynamicState_copy_to_vars_p(&src, __VA_ARGS__)

typedef base_array_t TmpOnePort_roo_air_fluInt_Medium_ThermodynamicState_array;
#define alloc_TmpOnePort_roo_air_fluInt_Medium_ThermodynamicState_array(dst,ndims,...) generic_array_create(NULL, dst, TmpOnePort_roo_air_fluInt_Medium_ThermodynamicState_construct_p, ndims, sizeof(TmpOnePort_roo_air_fluInt_Medium_ThermodynamicState), __VA_ARGS__)
#define TmpOnePort_roo_air_fluInt_Medium_ThermodynamicState_array_copy_data(src,dst)   generic_array_copy_data(src, &dst, TmpOnePort_roo_air_fluInt_Medium_ThermodynamicState_copy_p, sizeof(TmpOnePort_roo_air_fluInt_Medium_ThermodynamicState))
#define TmpOnePort_roo_air_fluInt_Medium_ThermodynamicState_array_alloc_copy(src,dst)  generic_array_alloc_copy(src, &dst, TmpOnePort_roo_air_fluInt_Medium_ThermodynamicState_copy_p, sizeof(TmpOnePort_roo_air_fluInt_Medium_ThermodynamicState))
#define TmpOnePort_roo_air_fluInt_Medium_ThermodynamicState_array_get(src,ndims,...)   (*(TmpOnePort_roo_air_fluInt_Medium_ThermodynamicState*)(generic_array_get(&src, sizeof(TmpOnePort_roo_air_fluInt_Medium_ThermodynamicState), __VA_ARGS__)))
#define TmpOnePort_roo_air_fluInt_Medium_ThermodynamicState_set(dst,val,...)           generic_array_set(&dst, &val, TmpOnePort_roo_air_fluInt_Medium_ThermodynamicState_copy_p, sizeof(TmpOnePort_roo_air_fluInt_Medium_ThermodynamicState), __VA_ARGS__)

typedef TmpOnePort_retSink_Medium_ThermodynamicState TmpOnePort_sup_Medium_ThermodynamicState;
extern struct record_description TmpOnePort_sup_Medium_ThermodynamicState__desc;

void TmpOnePort_sup_Medium_ThermodynamicState_construct_p(threadData_t *threadData, void* v_ths );
#define TmpOnePort_sup_Medium_ThermodynamicState_construct(td, ths ) TmpOnePort_sup_Medium_ThermodynamicState_construct_p(td, &ths )
void TmpOnePort_sup_Medium_ThermodynamicState_copy_p(void* v_src, void* v_dst);
#define TmpOnePort_sup_Medium_ThermodynamicState_copy(src,dst) TmpOnePort_sup_Medium_ThermodynamicState_copy_p(&src, &dst)
...
#define TmpOnePort_sup_Medium_ThermodynamicState_wrap_vars(td, dst , in_p, in_T, in_X) TmpOnePort_sup_Medium_ThermodynamicState_wrap_vars_p(td, &dst , in_p, in_T, in_X)

// This function is not needed anymore. If you want to know how a record
// is 'assigned to' in simulation context see assignRhsExpToRecordCrefSimContext and
// splitRecordAssignmentToMemberAssignments (simCode). Basically the record is
// split up assignments generated for each member individually.
// void TmpOnePort_sup_Medium_ThermodynamicState_copy_to_vars_p(void* v_src , modelica_real* in_p, modelica_real* in_T, real_array* in_X);
// #define TmpOnePort_sup_Medium_ThermodynamicState_copy_to_vars(src,...) TmpOnePort_sup_Medium_ThermodynamicState_copy_to_vars_p(&src, __VA_ARGS__)

typedef base_array_t TmpOnePort_sup_Medium_ThermodynamicState_array;
#define alloc_TmpOnePort_sup_Medium_ThermodynamicState_array(dst,ndims,...) generic_array_create(NULL, dst, TmpOnePort_sup_Medium_ThermodynamicState_construct_p, ndims, sizeof(TmpOnePort_sup_Medium_ThermodynamicState), __VA_ARGS__)
#define TmpOnePort_sup_Medium_ThermodynamicState_array_copy_data(src,dst)   generic_array_copy_data(src, &dst, TmpOnePort_sup_Medium_ThermodynamicState_copy_p, sizeof(TmpOnePort_sup_Medium_ThermodynamicState))
#define TmpOnePort_sup_Medium_ThermodynamicState_array_alloc_copy(src,dst)  generic_array_alloc_copy(src, &dst, TmpOnePort_sup_Medium_ThermodynamicState_copy_p, sizeof(TmpOnePort_sup_Medium_ThermodynamicState))
#define TmpOnePort_sup_Medium_ThermodynamicState_array_get(src,ndims,...)   (*(TmpOnePort_sup_Medium_ThermodynamicState*)(generic_array_get(&src, sizeof(TmpOnePort_sup_Medium_ThermodynamicState), __VA_ARGS__)))
#define TmpOnePort_sup_Medium_ThermodynamicState_set(dst,val,...)           generic_array_set(&dst, &val, TmpOnePort_sup_Medium_ThermodynamicState_copy_p, sizeof(TmpOnePort_sup_Medium_ThermodynamicState), __VA_ARGS__)
...
static const MMC_DEFSTRUCTLIT(boxvar_lit_TmpOnePort_retSink_Medium_ThermodynamicState,2,0) {(void*) boxptr_TmpOnePort_retSink_Medium_ThermodynamicState,0}};
#define boxvar_TmpOnePort_retSink_Medium_ThermodynamicState MMC_REFSTRUCTLIT(boxvar_lit_TmpOnePort_retSink_Medium_ThermodynamicState)
...
static const MMC_DEFSTRUCTLIT(boxvar_lit_TmpOnePort_roo_air_Medium_ThermodynamicState,2,0) {(void*) boxptr_TmpOnePort_roo_air_Medium_ThermodynamicState,0}};
#define boxvar_TmpOnePort_roo_air_Medium_ThermodynamicState MMC_REFSTRUCTLIT(boxvar_lit_TmpOnePort_roo_air_Medium_ThermodynamicState)
...
static const MMC_DEFSTRUCTLIT(boxvar_lit_TmpOnePort_roo_air_cfd_assertStringsAreUnique,2,0) {(void*) boxptr_TmpOnePort_roo_air_cfd_assertStringsAreUnique,0}};
#define boxvar_TmpOnePort_roo_air_cfd_assertStringsAreUnique MMC_REFSTRUCTLIT(boxvar_lit_TmpOnePort_roo_air_cfd_assertStringsAreUnique)
...
static const MMC_DEFSTRUCTLIT(boxvar_lit_TmpOnePort_roo_air_cfd_exchange,2,0) {(void*) boxptr_TmpOnePort_roo_air_cfd_exchange,0}};
#define boxvar_TmpOnePort_roo_air_cfd_exchange MMC_REFSTRUCTLIT(boxvar_lit_TmpOnePort_roo_air_cfd_exchange)
...
static const MMC_DEFSTRUCTLIT(boxvar_lit_TmpOnePort_roo_air_cfd_returnNonUniqueStrings,2,0) {(void*) boxptr_TmpOnePort_roo_air_cfd_returnNonUniqueStrings,0}};
#define boxvar_TmpOnePort_roo_air_cfd_returnNonUniqueStrings MMC_REFSTRUCTLIT(boxvar_lit_TmpOnePort_roo_air_cfd_returnNonUniqueStrings)
...
static const MMC_DEFSTRUCTLIT(boxvar_lit_TmpOnePort_roo_air_cfd_sendParameters,2,0) {(void*) boxptr_TmpOnePort_roo_air_cfd_sendParameters,0}};
#define boxvar_TmpOnePort_roo_air_cfd_sendParameters MMC_REFSTRUCTLIT(boxvar_lit_TmpOnePort_roo_air_cfd_sendParameters)
...
static const MMC_DEFSTRUCTLIT(boxvar_lit_TmpOnePort_roo_air_fluInt_Medium_ThermodynamicState,2,0) {(void*) boxptr_TmpOnePort_roo_air_fluInt_Medium_ThermodynamicState,0}};
#define boxvar_TmpOnePort_roo_air_fluInt_Medium_ThermodynamicState MMC_REFSTRUCTLIT(boxvar_lit_TmpOnePort_roo_air_fluInt_Medium_ThermodynamicState)
...
static const MMC_DEFSTRUCTLIT(boxvar_lit_TmpOnePort_roo_irRadExc_checkSurfaceAreas,2,0) {(void*) boxptr_TmpOnePort_roo_irRadExc_checkSurfaceAreas,0}};
#define boxvar_TmpOnePort_roo_irRadExc_checkSurfaceAreas MMC_REFSTRUCTLIT(boxvar_lit_TmpOnePort_roo_irRadExc_checkSurfaceAreas)
...
static const MMC_DEFSTRUCTLIT(boxvar_lit_TmpOnePort_roo_irRadGai_checkSurfaceAreas,2,0) {(void*) boxptr_TmpOnePort_roo_irRadGai_checkSurfaceAreas,0}};
#define boxvar_TmpOnePort_roo_irRadGai_checkSurfaceAreas MMC_REFSTRUCTLIT(boxvar_lit_TmpOnePort_roo_irRadGai_checkSurfaceAreas)
...
static const MMC_DEFSTRUCTLIT(boxvar_lit_TmpOnePort_roo_radTem_checkSurfaceAreas,2,0) {(void*) boxptr_TmpOnePort_roo_radTem_checkSurfaceAreas,0}};
#define boxvar_TmpOnePort_roo_radTem_checkSurfaceAreas MMC_REFSTRUCTLIT(boxvar_lit_TmpOnePort_roo_radTem_checkSurfaceAreas)
...
static const MMC_DEFSTRUCTLIT(boxvar_lit_TmpOnePort_sup_Medium_ThermodynamicState,2,0) {(void*) boxptr_TmpOnePort_sup_Medium_ThermodynamicState,0}};
#define boxvar_TmpOnePort_sup_Medium_ThermodynamicState MMC_REFSTRUCTLIT(boxvar_lit_TmpOnePort_sup_Medium_ThermodynamicState)
