...
#include "tmp_two_returns_res_includes.h"
...
{
  TmpTwoReturnsRes_ret_Medium_ThermodynamicState tmp1;
  tmp1._p = omc_p;
  tmp1._T = omc_T;
  tmp1._X = omc_X;
  return tmp1;
...
{
  return mmc_mk_box4(3, &TmpTwoReturnsRes_ret_Medium_ThermodynamicState__desc, _p, _T, _X);
}
...
{
  TmpTwoReturnsRes_retRes1_Medium_ThermodynamicState tmp1;
  tmp1._p = omc_p;
  tmp1._T = omc_T;
  tmp1._X = omc_X;
  return tmp1;
...
{
  return mmc_mk_box4(3, &TmpTwoReturnsRes_retRes1_Medium_ThermodynamicState__desc, _p, _T, _X);
}
...
{
  TmpTwoReturnsRes_retRes2_Medium_ThermodynamicState tmp1;
  tmp1._p = omc_p;
  tmp1._T = omc_T;
  tmp1._X = omc_X;
  return tmp1;
...
{
  return mmc_mk_box4(3, &TmpTwoReturnsRes_retRes2_Medium_ThermodynamicState__desc, _p, _T, _X);
}
...
{
  TmpTwoReturnsRes_roo_air_Medium_ThermodynamicState tmp1;
  tmp1._p = omc_p;
  tmp1._T = omc_T;
  tmp1._X = omc_X;
  return tmp1;
...
{
  return mmc_mk_box4(3, &TmpTwoReturnsRes_roo_air_Medium_ThermodynamicState__desc, _p, _T, _X);
}
  ...
  if((_n > ((modelica_integer) 1)))
  {
...

    {
      if(!(!omc_Modelica_Math_BooleanVectors_anyTrue(threadData, _ideNam)))
      {
        ...
        tmpMeta11 = stringAppend(tmpMeta10,omc_TmpTwoReturnsRes_roo_air_cfd_returnNonUniqueStrings(threadData, _n, _ideNam, _names));
        {
...
void boxptr_TmpTwoReturnsRes_roo_air_cfd_assertStringsAreUnique(threadData_t *threadData, modelica_metatype _descriptiveName, modelica_metatype _n, modelica_metatype _names)
{
  modelica_integer tmp1;
  tmp1 = mmc_unbox_integer(_n);
  omc_TmpTwoReturnsRes_roo_air_cfd_assertStringsAreUnique(threadData, _descriptiveName, tmp1, *((base_array_t*)_names));
  return;
}
...
modelica_metatype boxptr_TmpTwoReturnsRes_roo_air_cfd_exchange(threadData_t *threadData, modelica_metatype _flag, modelica_metatype _t, modelica_metatype _dt, modelica_metatype _u, modelica_metatype _nU, modelica_metatype _yFixed, modelica_metatype _nY, modelica_metatype *out_y, modelica_metatype *out_retVal)
{
  ...
  tmp4 = mmc_unbox_integer(_nU);
  tmp5 = mmc_unbox_integer(_nY);
  _modTimRea = omc_TmpTwoReturnsRes_roo_air_cfd_exchange(threadData, tmp1, tmp2, tmp3, *((base_array_t*)_u), tmp4, *((base_array_t*)_yFixed), tmp5, &_y, &_retVal);
  out_modTimRea = mmc_mk_rcon(_modTimRea);
  if (out_y) { *out_y = mmc_mk_modelica_array(_y); }
  if (out_retVal) { *out_retVal = mmc_mk_icon(_retVal); }
  return out_modTimRea;
...
modelica_metatype boxptr_TmpTwoReturnsRes_roo_air_cfd_returnNonUniqueStrings(threadData_t *threadData, modelica_metatype _n, modelica_metatype _ideNam, modelica_metatype _names)
{
  ...
  modelica_string _s = NULL;
  tmp1 = mmc_unbox_integer(_n);
  _s = omc_TmpTwoReturnsRes_roo_air_cfd_returnNonUniqueStrings(threadData, tmp1, *((base_array_t*)_ideNam), *((base_array_t*)_names));
  /* skip box _s; String */
  return _s;
}
...
void boxptr_TmpTwoReturnsRes_roo_air_cfd_sendParameters(threadData_t *threadData, modelica_metatype _cfdFilNam, modelica_metatype _name, modelica_metatype _A, modelica_metatype _til, modelica_metatype _bouCon, modelica_metatype _nPorts, modelica_metatype _portName, modelica_metatype _haveSensor, modelica_metatype _sensorName, modelica_metatype _haveShade, modelica_metatype _nSur, modelica_metatype _nSen, modelica_metatype _nConExtWin, modelica_metatype _nXi, modelica_metatype _nC, modelica_metatype _rho_start)
{
  ...
  tmp8 = mmc_unbox_integer(_nC);
  tmp9 = mmc_unbox_real(_rho_start);
  omc_TmpTwoReturnsRes_roo_air_cfd_sendParameters(threadData, _cfdFilNam, *((base_array_t*)_name), *((base_array_t*)_A), *((base_array_t*)_til), *((base_array_t*)_bouCon), tmp1, *((base_array_t*)_portName), tmp2, *((base_array_t*)_sensorName), tmp3, tmp4, tmp5, tmp6, tmp7, tmp8, tmp9);
  return;
}
...
{
  TmpTwoReturnsRes_roo_air_fluInt_Medium_ThermodynamicState tmp1;
  tmp1._p = omc_p;
  tmp1._T = omc_T;
  tmp1._X = omc_X;
  return tmp1;
...
{
  return mmc_mk_box4(3, &TmpTwoReturnsRes_roo_air_fluInt_Medium_ThermodynamicState__desc, _p, _T, _X);
}
...
void boxptr_TmpTwoReturnsRes_roo_irRadExc_checkSurfaceAreas(threadData_t *threadData, modelica_metatype _n, modelica_metatype _A, modelica_metatype _name)
{
  modelica_integer tmp1;
  tmp1 = mmc_unbox_integer(_n);
  omc_TmpTwoReturnsRes_roo_irRadExc_checkSurfaceAreas(threadData, tmp1, *((base_array_t*)_A), _name);
  return;
}
...
void boxptr_TmpTwoReturnsRes_roo_irRadGai_checkSurfaceAreas(threadData_t *threadData, modelica_metatype _n, modelica_metatype _A, modelica_metatype _name)
{
  modelica_integer tmp1;
  tmp1 = mmc_unbox_integer(_n);
  omc_TmpTwoReturnsRes_roo_irRadGai_checkSurfaceAreas(threadData, tmp1, *((base_array_t*)_A), _name);
  return;
}
...
void boxptr_TmpTwoReturnsRes_roo_radTem_checkSurfaceAreas(threadData_t *threadData, modelica_metatype _n, modelica_metatype _A, modelica_metatype _name)
{
  modelica_integer tmp1;
  tmp1 = mmc_unbox_integer(_n);
  omc_TmpTwoReturnsRes_roo_radTem_checkSurfaceAreas(threadData, tmp1, *((base_array_t*)_A), _name);
  return;
}
...
{
  TmpTwoReturnsRes_sup1_Medium_ThermodynamicState tmp1;
  tmp1._p = omc_p;
  tmp1._T = omc_T;
  tmp1._X = omc_X;
  return tmp1;
...
{
  return mmc_mk_box4(3, &TmpTwoReturnsRes_sup1_Medium_ThermodynamicState__desc, _p, _T, _X);
}
...
{
  TmpTwoReturnsRes_sup2_Medium_ThermodynamicState tmp1;
  tmp1._p = omc_p;
  tmp1._T = omc_T;
  tmp1._X = omc_X;
  return tmp1;
...
{
  return mmc_mk_box4(3, &TmpTwoReturnsRes_sup2_Medium_ThermodynamicState__desc, _p, _T, _X);
}
