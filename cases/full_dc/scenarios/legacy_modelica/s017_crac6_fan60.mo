// Auto-generated scenario: s017_crac6_fan60
// CRAC 6 fan @ 60%, rest @ 100%
model Scenario_s017_crac6_fan60
  ...
  Modelica.Blocks.Sources.CombiTimeTable fanTable(
    table = [0, 1.0000, 1.0000, 1.0000, 1.0000, 1.0000, 0.6000;
             900, 1.0000, 1.0000, 1.0000, 1.0000, 1.0000, 0.6000],
    columns = 2:7,
