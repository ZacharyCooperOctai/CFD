// Auto-generated scenario: s012_crac4_fan40
// CRAC 4 fan @ 40%, rest @ 100%
model Scenario_s012_crac4_fan40
  ...
  Modelica.Blocks.Sources.CombiTimeTable fanTable(
    table = [0, 1.0000, 1.0000, 1.0000, 0.4000, 1.0000, 1.0000;
             900, 1.0000, 1.0000, 1.0000, 0.4000, 1.0000, 1.0000],
    columns = 2:7,
