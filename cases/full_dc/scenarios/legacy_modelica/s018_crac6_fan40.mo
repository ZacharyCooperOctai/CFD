// Auto-generated scenario: s018_crac6_fan40
// CRAC 6 fan @ 40%, rest @ 100%
model Scenario_s018_crac6_fan40
  ...
  Modelica.Blocks.Sources.CombiTimeTable fanTable(
    table = [0, 1.0000, 1.0000, 1.0000, 1.0000, 1.0000, 0.4000;
             900, 1.0000, 1.0000, 1.0000, 1.0000, 1.0000, 0.4000],
    columns = 2:7,
