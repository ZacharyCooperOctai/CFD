// Auto-generated scenario: s005_crac2_fan60
// CRAC 2 fan @ 60%, rest @ 100%
model Scenario_s005_crac2_fan60
  ...
  Modelica.Blocks.Sources.CombiTimeTable fanTable(
    table = [0, 1.0000, 0.6000, 1.0000, 1.0000, 1.0000, 1.0000;
             900, 1.0000, 0.6000, 1.0000, 1.0000, 1.0000, 1.0000],
    columns = 2:7,
