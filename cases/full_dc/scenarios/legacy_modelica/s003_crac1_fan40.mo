// Auto-generated scenario: s003_crac1_fan40
// CRAC 1 fan @ 40%, rest @ 100%
model Scenario_s003_crac1_fan40
  ...
  Modelica.Blocks.Sources.CombiTimeTable fanTable(
    table = [0, 0.4000, 1.0000, 1.0000, 1.0000, 1.0000, 1.0000;
             900, 0.4000, 1.0000, 1.0000, 1.0000, 1.0000, 1.0000],
    columns = 2:7,
