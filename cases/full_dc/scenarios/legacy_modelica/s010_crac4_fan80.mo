// Auto-generated scenario: s010_crac4_fan80
// CRAC 4 fan @ 80%, rest @ 100%
model Scenario_s010_crac4_fan80
  ...
  Modelica.Blocks.Sources.CombiTimeTable fanTable(
    table = [0, 1.0000, 1.0000, 1.0000, 0.8000, 1.0000, 1.0000;
             900, 1.0000, 1.0000, 1.0000, 0.8000, 1.0000, 1.0000],
    columns = 2:7,
