...
#ifndef _DATA_STRUCTURE_GPU_H
#define _DATA_STRUCTURE_GPU_H
...
#define APYS 63
#define APZS 64
#define MV   65 //velocity magnitude
#define MVM  66 //velocity magnitude mean
#define C2BC 67  // Last variable
...
typedef enum {TILE_ONLY, TILE_ROOM, TILE_ROOM_WHOLE } DC_SPACE;
...
typedef struct {
  ...
  int nextstep; // Internal: 1: yes; 0: no, wait
	...
	DC_SPACE dc_space; // TILE_ONLY: only model tile; TILE_ROOM: model tile and room together
}SOLV_DATA;
...
/* static char msg[1000]={0}; */ // removed: program-scope var illegal in OpenCL C
#endif
